...
const deliverySchema = new mongoose.Schema({
  ...
  uzCoder: { type: mongoose.Schema.Types.ObjectId, ref: 'Coder' },
  kzCoder: { type: mongoose.Schema.Types.ObjectId, ref: 'Coder' },
  avgCoder: { type: mongoose.Schema.Types.ObjectId, ref: 'Coder' },
